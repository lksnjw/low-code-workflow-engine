...
/*******************************************************************************
 * Function: handleRegistryRoute
 *
 * Dispatches tool, rule, context, and registry import requests.
 ******************************************************************************/
 ...
 *
 * Rejects registry mutations when the configured policy source owns the
 * rules.
 ******************************************************************************/
 ...
 *
 * Reports current registry versions, counts, and policy information.
 ******************************************************************************/
 ...
 * Function: createTool
 *
 * Validates and creates a registry tool, then records the change.
 ******************************************************************************/
 ...
 * Function: updateTool
 *
 * Validates and updates a registry tool, then records the change.
 ******************************************************************************/
 ...
 * Function: createRule
 *
 * Validates and creates a registry rule, then records the change.
 ******************************************************************************/
 ...
 * Function: updateRule
 *
 * Validates and updates a registry rule, then records the change.
 ******************************************************************************/
 ...
 *
 * Extracts registry input from a JSON body or uploaded content.
 ******************************************************************************/
 ...
 *
 * Imports tool definitions through the registry service and records the
 * result.
 ******************************************************************************/
 ...
 *
 * Imports rule definitions through the registry service and records the
 * result.
 ******************************************************************************/
 ...
 * Function: getContext
 *
 * Returns the current registry context document.
 ******************************************************************************/
 ...
 *
 * Rebuilds and stores context from the current registry snapshot.
 ******************************************************************************/
 ...
 *
 * Returns stored registry context revisions.
 ******************************************************************************/
 ...
 *
 * Writes registry context and records its revision history.
 ******************************************************************************/
 ...
 *
 * Formats registry tools and rules into a context document.
 ******************************************************************************/
 ...
 *
 * Resolves the configured registry context file path.
 ******************************************************************************/
 ...
 *
 * Analyses supplied registry content before it is committed.
 ******************************************************************************/
 ...
 *
 * Applies a previously prepared registry import and records its result.
 ******************************************************************************/
 ...
 *
 * Returns registry import history.
 ******************************************************************************/
 ...
 *
 * Records a registry operation in the audit log.
 ******************************************************************************/
