...
function SettingsPage() {
  ...
  return <div className="space-y-6"><div><h1 className="page-heading text-gray-950 dark:text-white">Platform Settings</h1><p className="mt-3 text-sm leading-6 text-gray-500 dark:text-gray-400">Runtime-owned values are displayed from backend configuration; business records come from the API.</p></div>
