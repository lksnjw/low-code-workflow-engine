...
export const lazyRouteComponents = {
  ...
  PipelineUploadPage: lazy(() => import("../pages/datafeed/PipelineUploadPage")),
...
const allProtectedRouteDefinitions = [
  ...
  { id: "pipeline_upload.upload", path: "/datafeed/upload", Component: C.PipelineUploadPage, requiredAny: [PERMISSIONS.WORKFLOW_READ], feature: "pipelineUpload" },
